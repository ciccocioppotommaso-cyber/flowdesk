...
import {
  IconArrowRight, IconTable, IconFork, IconReceipt, IconCalendar, IconUsers, IconChartBar,
} from '../components/icons'

const FEATURES = [
  { Icon: IconTable, title: 'Tavoli & QR', description: 'Mappa sala interattiva e ordini dal tavolo via QR code.' },
  { Icon: IconFork, title: 'Menu digitale', description: 'Aggiorna piatti, prezzi e disponibilità in tempo reale.' },
  { Icon: IconReceipt, title: 'Ordini & conti', description: 'Tutto quello che arriva in cucina già organizzato.' },
  { Icon: IconCalendar, title: 'Prenotazioni', description: 'Calendario e lista d\'attesa gestiti senza telefonate perse.' },
  { Icon: IconUsers, title: 'Staff & turni', description: 'Disponibilità, turni e generazione automatica con AI.' },
  { Icon: IconChartBar, title: 'Analytics', description: 'Incassi, piatti più venduti e performance del locale.' },
]
    ...
    <main className="min-h-screen bg-mist overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 relative">
          ...
          <div className="py-20 sm:py-28 max-w-2xl mx-auto text-center">
            <div className="flex justify-center">
              <Logo size={26} dark product="food" withWordmark />
            </div>
            ...
            <p className="animate-fade-up mt-6 text-lg text-white/60 leading-relaxed max-w-xl mx-auto" style={{ animationDelay: '160ms' }}>
              Tavoli, menu digitale, ordini QR, prenotazioni, staff e analytics.
              Il cliente ordina dal tavolo, tu ricevi tutto già organizzato.
            </p>
            <button
              onClick={scegliFood}
      ...
      <section className="max-w-6xl mx-auto px-6 py-20">
        ...
        <div className="mt-14 bg-ink-navy rounded-2xl p-8 sm:p-10 flex flex-col sm:flex-row items-center justify-between gap-6 text-center sm:text-left">
          <div>
            <h3 className="text-xl font-extrabold text-white">Pronto a mettere in ordine il tuo locale?</h3>
